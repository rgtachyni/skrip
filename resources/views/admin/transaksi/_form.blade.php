                    ...
                    <div class="row g-9 mb-8">
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="position-relative">
                                <input type="text" class="form-control" name="nama_wisata" id="nama" />
                            </div>
                        </div>
                        <div class="col-md-6 fv-row">
                            <label class="d-flex align-items-center fs-6 fw-semibold form-label mb-2">
                            ...
                            <div class="position-relative">
                                <select name="kategori_id" class="form-select " data-control="select2"
                                    data-hide-search="false" id="kecamatan_id">
                                    <option value="">Pilih Kategori</option>
                                    <?php foreach (Helper::getData('kategori') as $row) : ?>
                        ...
                        <div class="d-flex flex-column fv-row">
                            <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                <span class="required">Link Lokasi Wisata</span>
                            </label>
