        ...
        <div class="c-layout-breadcrumbs-1 c-fonts-uppercase c-fonts-bold c-bordered c-bordered-both">
            <div class="container">
                <div class="c-page-title c-pull-left">
                    <h3 class="c-font-uppercase c-font-sbold">Sejarah</h3>
                </div>
                <ul class="c-page-breadcrumbs c-theme-nav c-pull-right c-fonts-regular">
                    <li><a href="#">Sejarah</a></li>
                    <li>/</li>
                    <li><a href="page-blog-post.html">Sejarah</a></li>
                </ul>
            </div>
                            ...
                            @foreach ($data as $v)
                                <div class="c-content-blog-post-1">
                                            ...
                                            <div class="" data-single-item="true" data-auto-play="4000"
                                                ...
                                                <div class="item">
                                                    <div class="c-content-media-2"
                                                        style="background-image: url({{ asset('public/uploads/sejarah/' . $v->gambar) }}); min-height: 460px;">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="c-title c-font-bold c-font-uppercase">
                                        <a href="{{ route('sejarah.detail', $v->id) }}">{{ $v->nama_budaya }}</a>
                                    </div>
